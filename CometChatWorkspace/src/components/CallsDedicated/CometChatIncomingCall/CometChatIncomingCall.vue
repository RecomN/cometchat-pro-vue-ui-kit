    ...
    <div :style="styles.callContainer">
      <div :style="styles.headerWrapper">
        ...
        <div :style="styles.thumbnail">
          <comet-chat-avatar
            :corner-radius="incomingCall.type === 'video' ? '10%' : '50%' "
            :image="incomingCall.sender.avatar"
          />
        </div>
      </div>
      <div :style="styles.headerButton">
        <button :style="styles.declineButton" @click="rejectCall" class="sejasa-action-call-btn decline-btn">
          {{ STRINGS.DECLINE }}
        </button>
        <button :style="styles.acceptButton" @click="acceptCall" class="sejasa-action-call-btn accept-btn">
          {{ STRINGS.ACCEPT }}
        </button>
      </div>
    </div>
...
import audioCallIcon from "./resources/newincomingaudiocall.svg";
import videoCallIcon from "./resources/newincomingvideocall.svg";
...
.sejasa-action-call-btn {
  flex: 1 !important;

  &.accept-btn {
    background-color: #4DB6E4 !important;
