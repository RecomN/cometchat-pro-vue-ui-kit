...
import newDetailIcon from "./resources/new_detailpane.png";
import newVideoIcon from "./resources/new_video.png";
import newAudioIcon from "./resources/new_audio.png";
  ...
  computed: {
    ...
    styles() {
      return {
        ...
        audioCallOption: style.chatOptionStyle(newAudioIcon, "audio"),
        videoCallOption: style.chatOptionStyle(newVideoIcon, "video"),
        detailPaneOption: style.chatOptionStyle(newDetailIcon, "detail"),
